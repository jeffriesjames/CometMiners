...
public class CraftSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //playerStatsScript = GameObject.FindGameObjectWithTag("PlayerI").GetComponent<PlayerScript>();
    }
    ...
    public void backToInventory()
    {
        ...
        {
            GameObject.FindGameObjectWithTag("PlayerI").GetComponent<PlayerInventory>().inventory.GetComponent<Inventory>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
